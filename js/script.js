...
url += '?' + $.param({'api-key': "58e7447484524db69db97ecdede76026"});
  ...
  $.ajax({
    ...
    //   console.log(value);
    //   $(".news-feed").append("<a href='"+value.url+"' class='article-link'><div class='article' style='background-image: url("+value.multimedia[4].url+")'><h2 class='news-text'>"+value.abstract+"</h2></div></a>");
    // })
  }).fail(function(err) {
    throw err;
  });
